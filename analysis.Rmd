...
```{r enhancehurt-vs-industry-edit}
...
```{r enhancehurt-vs-industry-plot}
...
```{r enhancehurt-vs-education-edit}
...
```{r enhancehurt-vs-education-plot}
...
```{r enhancehurt-vs-gender-plot}
# Visualize using different histogram for each gender.
# Show the number of respondents on each bar.
